-- Fix complete_sale to use tenant_members instead of staff
-- And allow passing tenant_id explicitly in payload with higher precedence for super admins
...
BEGIN
  ...
  -- Precedence: 1. Payload _tenant_id, 2. User's tenant_membership
